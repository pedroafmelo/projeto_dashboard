...
class EmAct:
    ...
    def __init__(self) -> None:
        ...
        self.hist_ind = self.indicators.get_theme_dict("em_macro_act")
        self.hist_ind_ids = self.indicators.get_ids_list("em_macro_act")
    ...
    def em_macro_cover(_self):
        ...
        col1.subheader("Indicadores Macro - Mercados Emergentes", divider="grey")
    ...
    def generate_graphs(self) -> None:
        ...
        if indicator_type == "Histórico":
            ...
            if "PIB" in indicator_filter:
                ...
                gdp = self.utils.get_gdp(em_countries[country_filter], self.hist_ind_ids[0])
            ...
            with st.spinner("Carregando os dados..."):
                ...
                gdp = self.utils.get_gdp(em_countries[indicator_filter], self.hist_ind_ids[0], forward=True)

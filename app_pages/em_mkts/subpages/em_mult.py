...
class EmMult:
    ...
    def __init__(self) -> None:
        ...
        self.ind = self.indicators.get_theme_dict("em_mkt_preco")
        self.ind_ids = self.indicators.get_ids_list("em_mkt_preco")
    ...
    def generate_graphs(self):
        ...
        files_list = [file.split("/")[-1] for file in json_list 
                      if "europe" not in file and "japan" not in file]

        emerging = {

            "América": [["Brasil", "Chile", "México", "Peru", "Colômbia"], files_list[1]],
            "Ásia": [["China", "Coréia do Sul", 
                     "Taiwan", "Tailândia", "Maláisa", "Índia", "Indonésia"], files_list[0]]
        ...
        with c1.popover("Sobre", icon=":material/info:"):
                st.markdown(self.ind["MSCI Emerging Markets Price-to-Earnings (P/E) Ratio"]["description"], unsafe_allow_html=True)